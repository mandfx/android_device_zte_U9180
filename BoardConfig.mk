...
TARGET_BOOTLOADER_BOARD_NAME := x9180
...
TARGET_RECOVERY_FSTAB := device/zte/x9180/recovery/fstab.qcom
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/zte/x9180/recovery/recovery_keys.c
